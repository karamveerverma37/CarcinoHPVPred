# -*- coding: utf-8 -*-
"""
Created on Wed Nov 25 13:30:20 2020
...
def rev_c(seq,k,dict_n,count1):
    ...
    for i in r_dict1.keys():
        ss="RDK_SPLIT_"+"s"+str(count1)+"_"+i
        dict_n[ss].append(r_dict1[i][0])

def sp(seq,split,dict_n,k):
    sq1 = []
    for i in seq:
        sq1.append(i)
    if(split>len(seq)):
