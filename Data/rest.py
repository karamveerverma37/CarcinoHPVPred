# -*- coding: utf-8 -*-
"""
Created on Sun Jul 26 17:04:33 2020
...
parser.add_argument("-or","--order",required=True,type=int, help="Enter the order value")
...
if (n+m)>len(sq):
    ...
    sys.exit()
if (n+m)<=order:
    print("Invalid Order and N,M value")
    sys.exit()
